...
public class GameNum1 {
    ...
    private int round;
    private Stack<Integer> coloda1 = new Stack<>();
    private Stack<Integer> coloda2 = new Stack<>();
    ...
    public void start() {
        ...
        while (!getColoda1().isEmpty() && !getColoda2().isEmpty() && getRound() < 106) {
            setRound(getRound() + 1);
            val1 = getColoda1().get(0);
            val2 = getColoda2().get(0);
            if (val1 == -1 || val2 == -1) {
    ...
    public Stack<Integer> getColoda1() {
        return coloda1;
    }

    public Stack<Integer> getColoda2() {
        return coloda2;
    }
